                    ...
                    <tr>
                        ...
                        <td>
                            <span style="overflow: visible; position: relative; width: 110px;">
                                ...
                                <button class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="modal" data-target="#Reforme" data-id="{{ $mat->id }}" data-serial="{{ $mat->serial }}" title="Reforme" {{ $mat->reforme_id ? 'Disabled' : ''}}>
