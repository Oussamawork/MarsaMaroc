                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        <div class="col-lg-4 {{ $errors->has('serial') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control m-input m-input--air m-input--pill m-form--state" id="inputDanger1"
                                name="serial" placeholder="Entrer la référence du matériel" value="{{ Session('serial') ? Session('serial') : old('serial') }}">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4 {{ $errors->has('date_acquisition') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control m-input m-input--air m-input--pill" id="acquisition_date"
                                name="date_acquisition" placeholder="Entrer la date d'acquisition" value="{{ Session('date_acquisition') ? Session('date_acquisition') : old('date_acquisition') }}">
                        ...
                        <div class="col-lg-4 {{ $errors->has('duree_guarantie') ? 'has-danger' : '' }}">
                            ...
                            <input type="text" class="form-control m-input m-input--air m-input--pill" name="duree_guarantie"
                                placeholder="Entrer la durée de guarantie" value="{{ Session('duree_guarantie') ? Session('duree_guarantie') : old('duree_guarantie') }}">
